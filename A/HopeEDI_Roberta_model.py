...
class Hope_with_Roberta_class:
    ...
    def tokenize(self): # tokenise + label encoding
        ...
        #Applying tokenization to our data
    ...
    def model_setup (self):
        ...
        self.model = RobertaForSequenceClassification.from_pretrained('roberta-base',
            ...
            output_attentions = False,  #  model does not returns attentions weights.
            output_hidden_states = False,  #   model does not returns all hidden-states.
        )
    ...
    def model_setup_balanced (self):
        #setups the roberta with balanced weights
    ...
    def training_pipeline_with_weights(self):
        ...
        #saving model
        self.model.save_pretrained('./roberta_model_with_weights')
        print("Model saved")
    ...
    def test(self):
      ...
      # Initialize lists to store true and predicted labels, and probabilities for all batches
      all_labels = []
      all_preds = []
      all_probs = []
    ...
    def run_fromsaved(self, path):
      #overall function to run and test the RoBERTa model from the pre-saved models
    ...
    def run_fromscratch_no_weights(self):
      #overall function to run the RoBERTa model from scratch without class weights
      #follow steps of:
      self.preprocess()
      self.tokenize()
      self.model_setup()
    ...
    def run_fromscratch_balanced(self):
      #overall function to run the RoBERTa model from scratch with class weights
      #follow steps of:
      self.preprocess()
      self.tokenize()
